...
import {
  ...
  getSellers,
  ProductType,
} from "./action"; // This will be created next
...
export function NewInvoiceForm() {
  ...
  const updateWeightRow = (
    rowName: keyof ProductDetails["weight"],
    index: number,
    value: number,
  ) => {
    setFormData((prev) => ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const promise = createInvoice(formData).then((result) => {
      if (result.success) {
                        ...
                        {values.map((value, index) => (
                          <td key={index} className="border border-border p-1">
                            <Input
                              ...
                              onChange={(e) =>
                                updateWeightRow(
                                  rowName as keyof ProductDetails["weight"],
                                  index,
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked: boolean) =>
                  updateProductDetails("isOrder", checked)
                }
              />
