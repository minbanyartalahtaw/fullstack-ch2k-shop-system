    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (result.success) {
                ...
                toast.error(result.error || 'ဝန်ထမ်းထည့်သွင်းရာတွင်အမှားတစ်ခုဖြစ်ပေါ်ခဲ့သည်');
            }
        } catch (error) {
        ...
        <div>
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                <DialogTrigger asChild className="mb-5" >
                    <Button variant="outline" size="sm" className="w-fit">Add New Staff</Button>
                </DialogTrigger>
                ...
                <DialogContent className="w-full">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div className="space-y-3">
                            <div>
                                <Label htmlFor="name" className="text-sm">ဝန်ထမ်းအမည်</Label>
                                <Input
                                    id="name"
                                    value={formData.name}
                            ...
                            <div>
                                <Label htmlFor="phone" className="text-sm">ဖုန်းနံပါတ်</Label>
                                <Input
                                    id="phone"
                            ...
                            <div>
                                <Label htmlFor="address" className="text-sm">လိပ်စာ</Label>
                                <Textarea
                                    id="address"
