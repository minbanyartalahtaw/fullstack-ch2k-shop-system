                ...
                <CardContent className="space-y-4">
                    <div className="space-y-2 flex justify-center items-center">
                        ...
                        <Input
                            ...
                            onChange={(e) => updateProductDetails("product_Name", e.target.value)}
                            required
                        />
                    </div>

                    <div className="space-y-2 flex  items-center">
                        <Label htmlFor="product_type_select" className="w-1/3 md:w-1/5">ပစ္စည်းအမျိုးအစား</Label>
                        <Select
                    ...
                    <div className="flex flex-col space-y-4">
                        ...
                        {formData.product_Details.isOrder && (
                            <div className="flex flex-col md:flex-row items-start justify-between space-x-0 md:space-x-2 space-y-2 md:space-y-0 md:items-end">
                                ...
                                <div className="flex-1 ">
                                    <Label htmlFor="remaining_amount" className="text-xs">ကျန်ငွေ</Label>
                                    <Input
                                        id="remaining_amount"
                                        type="number"
                                ...
                                <div className="flex-1">
                                    <Label htmlFor="appointment_date_input" className="text-xs">ရက်ချိန်း</Label>
                                    <Popover>
                                        <PopoverTrigger asChild>
                                            <Button variant={"outline"} className="w-full" type="button">
                                                <AppIcon name="calendar" className={`mr-2 h-4 w-4 ${!formData.appointment_Date ? 'text-red-500' : ''}`} />
                                                {formData.appointment_Date ? formData.appointment_Date.toLocaleDateString() : <span className={`${!formData.appointment_Date ? 'text-red-500' : ''}`}>ရက်ချိန်းရွှေးရန်</span>}
                                            </Button>
                                        </PopoverTrigger>
                                        <PopoverContent className="w-auto p-0 ">
                                            <Calendar
