...
export function InvoiceHistoryTable({ initialFilters, onLoadingChange }: InvoiceHistoryTableProps) {
  // State
  ...
  const renderTableBody = () => {
    ...
    return invoices.map(invoice => (
      <TableRow key={invoice.id}>
        ...
        {columnVisibility.invoiceNumber && <TableCell className='border'>{invoice.invoiceId}</TableCell>}
