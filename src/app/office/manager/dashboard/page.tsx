...
async function DashboardContent() {
    ...
    const { orderedProducts, takenProducts, productTypeData } = await getProductStats();
    ...
    return (
        <div className="space-y-6">
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                <Card>
                    ...
                    <CardContent>
                        <Table>
                            <TableBody>
                                <TableRow>
                                    <TableCell className="text-sm text-muted-foreground">စုစုပေါင်းဘောက်ချာ</TableCell>
                                    <TableCell className="text-right">
                                        <span className=" font-bold">{totalInvoices}</span>
                                    </TableCell>
                                    <TableCell className="text-sm text-muted-foreground">ခု</TableCell>
                                </TableRow>
                                <TableRow>
                                    <TableCell className="text-sm text-muted-foreground">အော်ဒါဘောက်ချာ</TableCell>
                                    <TableCell className="text-right">
                                ...
                                <TableRow>
                                    <TableCell className="text-sm text-muted-foreground">အရောင်းဘောက်ချာ</TableCell>
                                    <TableCell className="text-right">
                                        <span className=" font-bold">{totalInvoices - orderedProducts}</span>
                                    </TableCell>
                                    <TableCell className="text-sm text-muted-foreground">ခု</TableCell>
                                </TableRow>
                            </TableBody>
                ...
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                        <CardTitle className="text-xl font-bold">အော်ဒါပစ္စည်းများ</CardTitle>
                    ...
                    <CardContent>
                        <Table>
                            <TableBody>
                                <TableRow>
                                    <TableCell className="text-sm text-muted-foreground">အော်ဒါပစ္စည်း</TableCell>
                                    <TableCell className="text-right">
                                        <span className="font-bold">{orderedProducts}</span>
                                    </TableCell>
                                    <TableCell className="text-sm text-muted-foreground">ခု</TableCell>
                                ...
                                <TableRow>
                                    <TableCell className="text-sm text-muted-foreground">ပစ္စည်းပေးပြီး</TableCell>
                                    <TableCell className="text-right">
                                ...
                                <TableRow>
                                    <TableCell className="text-sm text-muted-foreground">ကျန်အော်ဒါ</TableCell>
                                    <TableCell className="text-right">
                                        <span className=" font-bold">{orderedProducts - takenProducts}</span>
                                    </TableCell>
                                    <TableCell className="text-sm text-muted-foreground">ခု</TableCell>
                                </TableRow>
                            </TableBody>
            ...
            <div className="grid gap-4 md:grid-cols-2">
                        ...
                        <div className="w-full max-w-md h-[300px]">
                            {productTypeData.labels.length > 0 ? (
                                ...
                                <div className="flex items-center justify-center h-full">
                                    <p className="text-sm text-muted-foreground">ပစ္စည်းအမျိုးအစား မရှိသေးပါ</p>
                                </div>
                            )}
                        </div>
                    </CardContent>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>ပြီးခဲ့သော ၆ လအတွင်း ဘောက်ချာအရေအတွက်ပြဇယား</CardDescription>
                    </CardHeader>
                    <CardContent className="flex justify-center">
    ...
    return (
        <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
            <div className="flex items-center justify-between space-y-2">
                <h2 className="text-3xl font-bold tracking-tight">စရင်းဇယား</h2>
            </div>
            <Separator />
